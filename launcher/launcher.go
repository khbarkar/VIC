...
var CLIs = []CLIInfo{
	{ID: "vic", Name: "VIC", PrimaryCmd: "vic-cli", FallbackCmd: "vic", CursorColor: "#D8863F", Category: "Code AI", About: "VIC local terminal coding assistant.", Models: []string{"VIC Chat"}},
	...
	{ID: "deepseek", Name: "DeepSeek", PrimaryCmd: "deepseek", FallbackCmd: "deepseek-cli", CursorColor: "#1F6FEB", Category: "Code AI", About: "DeepSeek terminal assistant for coding workflows.", Models: []string{"DeepSeek Chat", "DeepSeek Coder"}},
